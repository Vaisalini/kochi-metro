...
const TrainCard = ({ train }) => {
  ...
  const getTrainCardStatus = (train) => {
    const conflicts = train.jobCards.critical > 0 || 
    ...
    >
      ...
      <div className="train-indicators">
        <div className="indicator">
          ...
          <span className={`indicator-value ${getCertificateStatus(train.fitness.rolling)}`}>
        ...
        <div className="indicator">
          ...
          <span className={`indicator-value ${getCertificateStatus(train.fitness.signal)}`}>
        ...
        <div className="indicator">
          ...
          <span className={`indicator-value ${getCertificateStatus(train.fitness.telecom)}`}>
        ...
        <div className="indicator">
          ...
          <span className={`indicator-value ${train.jobCards.open > 0 ? 'warning' : 'good'}`}>
